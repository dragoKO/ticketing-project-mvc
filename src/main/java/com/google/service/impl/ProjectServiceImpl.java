...
import com.google.enums.Status;
...
public class ProjectServiceImpl extends AbstractMapService<ProjectDTO, String> implements ProjectService {
    ...
    public void update(ProjectDTO object) {
        ...
        if (object.getProjectStatus() == null) object.setProjectStatus(projectDTO.getProjectStatus());
    ...
    @Override
    public void completed(ProjectDTO projectDTO) {
